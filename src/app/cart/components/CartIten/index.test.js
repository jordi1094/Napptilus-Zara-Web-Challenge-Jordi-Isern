...
describe("CartItem Component", () => {
  ...
  test("debe renderizar el nombre, capacidad, color y precio correctamente", () => {
    render(<CartItem product={mockProduct} index={0} onDeleteItem={mockOnDeleteItem} />);
  ...
  test("debe renderizar la imagen del producto correctamente", () => {
    ...
    const img = screen.getByAltText("image from GALAXY S24 ULTRA in color TITANIUM YELLOW");
