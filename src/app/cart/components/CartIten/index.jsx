...
export default function CartItem ({product, index, onDeleteItem}) {
    ...
    return (
        <div className={style.cartItem}>
            ...
            <Image className={`${style.itemImage} object-contain`} src={product.selectedColor.imageUrl} fill sizes="(max-width:768px) 100vw, (max-width:1200px) 60vw" alt={`image from ${productName} in color ${productColor}`}/>
        </div>
    )
}